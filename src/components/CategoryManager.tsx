  ...
  return (
    <div className="grid gap-4">
      <form action={saveCategory} className="grid gap-3 rounded-2xl bg-cream/60 p-3">
        ...
        <input className={inputClass} name="monthlyBudget" type="number" inputMode="numeric" value={monthlyBudget} onChange={(event) => setMonthlyBudget(event.target.value)} placeholder="月予算（支出カテゴリ用）" />
