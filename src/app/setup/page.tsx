  ...
  return (
    <main className="mx-auto grid min-h-screen w-full max-w-md content-center gap-6 bg-cream px-5 py-10">
      <section>
        ...
        <p className="mt-2 text-sm leading-6 text-ink/60">夫婦で共有する家計の単位を作ります。</p>
      </section>
      <form action={setupHousehold} className="grid gap-3 rounded-[22px] bg-white p-5 shadow-soft">
        <input className="min-h-14 rounded-2xl border border-emerald-900/10 bg-cream/70 px-4 text-base outline-none focus:border-leaf" name="groupName" placeholder="家計グループ名" defaultValue="わが家の家計" required />
        ...
        <select className="min-h-14 rounded-2xl border border-emerald-900/10 bg-cream/70 px-4 text-base outline-none focus:border-leaf" name="burdenRule" defaultValue="fifty_fifty">
